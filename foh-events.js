...
function renderMain(){
  ...
  if(sec) sec.textContent = tab==='revenue' ? 'Revenue' : (tab==='operations' ? 'Closing Report' : (tab==='stocktake' ? 'Stock Take' : (tab==='admin' ? 'Admin' : (tab==='privateevents' ? 'Events' : (tab==='dashboard' ? 'Leaders' : 'Activations')))));
