  ...
  'coo-events-2': {
    ...
    items: [
      ...
      { said: 'You said: “minimum target sale expressed in number of events and revenue”.',
        ...
        shipped: { build:'2026-07-18.1', in:'8de7b9a', what:'The Monthly report now carries a target for the month and measures the month against it: target, converted so far, and what is still to find. Your <b>AED 150,000</b> is in for July and August, held as <b>net</b> — what finance books. Bookings are quoted gross, so every figure shows the other underneath it and the two are never read against the wrong basis. Valentina never touches this screen.<br><br><b>One thing we did not do:</b> you asked for the target as a number of events <i>and</i> revenue, and gave us the revenue. The <b>event count is empty</b>, and the card says so — we would not put a number on your report that you did not give us. Tell us the count and it goes in.', check:'Events → Monthly report → “Target for August”. It reads AED 150,000 net (about AED 185,377 at menu prices) against what has converted, with the shortfall and the % of target. The number-of-events box is blank and says why.' },
        fixes: 'coo-events/10',
  ...
  'coo-events': {
    ...
    items: [
      ...
      { said: '“How much money is on the calendar in July?”',
        ...
        shipped: { build:'2026-07-16.7', in:'59c4374', what:'Every booking on the calendar now carries its value, and the month header adds them up — <b>converted</b> money separated from what is still <b>in play</b>, because a calendar full of maybes is not a calendar full of money. And to your note on it: a full buyout is marked with a heavy border and a dot, so it can never read like a normal booking in one room.', check:'Events → Calendar. Each booking shows its value under the name, and the month header reads “N events · AED X converted · Y in play”.' },
      ...
      { said: '“What were events supposed to deliver this month?”',
        ...
        shipped: { build:'2026-07-18.1', in:'8de7b9a', what:'The report now carries a target for the month and gives a verdict against it: target, converted so far, and what is still to find. Your <b>AED 150,000</b> is in for July and August, held as <b>net</b> — what finance books — with the gross shown beside it so the basis is never guessed.<br><br><b>Still missing:</b> you asked for the target as a number of events <i>and</i> revenue, and gave us the revenue. The <b>event count is empty</b> and the card says so — we would not put a figure on your report that you did not give us.', check:'Events → Monthly report → “Target for August”. AED 150,000 net against what has converted, with the shortfall and the % of target.' },
      ...
      { said: '“Who sold these, and where did they come from?”',
        ...
        shipped: { build:'2026-07-17.1', in:'ed3682b', what:'Every booking now records <b>where it came from</b> and <b>who is handling it</b> — walk-in, referral, promoter, call centre — with a note for what a promoter is owed. The handler defaults to whoever created it, so it costs Valentina one dropdown, not two chores. Source and handler ride under the client name in the monthly report, so attribution is on the page.', check:'Events → Monthly report. Under each client name you see the source and who is handling it, e.g. “Promoter · w/ vdetoni”.' },
  ...
  'events-20': {
    ...
    items: [
      ...
      { said: '“Canapés in the Cortile first, then dinner in Piemonte.”',
        ...
        shipped: { build:'2026-07-18.1', in:'8de7b9a', what:'One booking now runs through more than one space. You add the second room and the time it starts, and there is nowhere to type a second price — you said “only 1 price”, so the guest gets one total for the whole evening. The team brief names both rooms, so the floor knows the night moves.', check:'Open a booking and use “+ Add a second space”, then print the proposal — the guest sees “Cortile 7:00 pm–8:30 pm, then Piemonte 8:30 pm–11:00 pm” and ONE price.' },
      ...
      { said: '“Send me three options and I\'ll pick one.”',
        ...
        shipped: { build:'2026-07-18.1', in:'8de7b9a', what:'The options live on ONE enquiry now. The guest gets one email with all of them, each with its own price, and your list shows one enquiry instead of three. When they choose, you tap “Guest chose this one” and it becomes the booking — nothing left to tidy up.', check:'Open an enquiry, tap “+ Offer options”, add two or three, then print the proposal — one page, every option on it. The list still shows one enquiry.' },
      ...
      { said: '“Either the 12th or the 19th — whichever you have.”',
        ...
        shipped: { build:'2026-07-18.1', in:'8de7b9a', what:'One booking holds both dates. It shows on the calendar on <b>every</b> date you are holding, so neither can be forgotten and nobody sells the other one out from under you — but it still counts <b>once</b> in the report, on the first date. When the guest picks, one tap sets that date and releases the others.', check:'Open a booking and tap “+ Add another possible date”. Both days now show it on the calendar — the held one is dashed and carries no money, and the month header says “1 date held”.' },
